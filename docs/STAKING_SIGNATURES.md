# Staking bond signatures — local runtime 102
...
transfer signatures are unchanged. Runtime spec version is 102; no storage
layout migration or live network upgrade was performed.
...
Local validation on 2026-09-24: PASS, 127 native workspace test executions
