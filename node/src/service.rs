...
use sc_consensus_babe::{BabeParams, ImportQueueParams, SlotProportion};
...
pub(crate) type FullClient = sc_service::TFullClient<
	...
	calibre_risc0_host::calibre_risc_0::HostFunctions,
)>,
>;
...
>(
	...
	// The import-queue request task exits when its last sender is dropped.
	// Retain the handle for the full lifetime of the node service.
	...
	if role.is_authority() {
		...
		// The BABE authoring task is essential: if it fails, stop the service.
		task_manager
